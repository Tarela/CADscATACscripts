...
results <- fread("SMC_rasqual_results_allpeaks_022421.txt")
results <- as_tibble(results)

#Read in permuted rasqual results
results_permuted1 <- fread("SMC_rasqual_results_allpeaks_perm1.txt")
results_permuted1 <- as_tibble(results_permuted1)
results_permuted2 <- fread("SMC_rasqual_results_allpeaks_perm2.txt")
results_permuted2 <- as_tibble(results_permuted2)
results_permuted3 <- fread("SMC_rasqual_results_allpeaks_perm3.txt")
results_permuted3 <- as_tibble(results_permuted3)
results_permuted4 <- fread("SMC_rasqual_results_allpeaks_perm4.txt")
results_permuted4 <- as_tibble(results_permuted4)
results_permuted5 <- fread("SMC_rasqual_results_allpeaks_perm5.txt")
...
FDR_results_SMC <- results_sorted %>% filter(keep == TRUE)

#Write results
write.table(FDR_results_SMC, file = "RASQUAL_results_SMC_FDR_0.05.txt", sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)